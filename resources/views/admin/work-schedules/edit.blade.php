...
@section('content_header')
    <h1>Edit Jadwal Kerja - {{ $employee->name }}</h1>
@stop
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Edit Jadwal Kerja</h3>
                ...
                <form action="{{ route('admin.work-schedules.update', $employee->id) }}" method="POST" id="scheduleForm">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        @if(session('error'))
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ $employee->name }} ({{ $employee->email }})" readonly>
                            <small class="text-muted">Karyawan tidak dapat diubah saat mengedit jadwal</small>
                        </div>

                        <div class="row">
                            <div class="col-12">
                                <h5 class="mb-3"><i class="fas fa-calendar-week"></i> Jadwal Kerja Mingguan</h5>
                                <p class="text-muted">Edit jadwal kerja untuk setiap hari dari Senin sampai Sabtu. Jam istirahat bersifat opsional.</p>
                            </div>
                        </div>

                        @foreach($workDays as $dayKey => $dayName)
                            @php
                                $existingSchedule = $schedules[$dayKey] ?? null;
                                $isActive = $existingSchedule && !$existingSchedule->is_holiday;
                            @endphp
                            ...
                            <div class="card card-outline card-primary mb-3">
                                    ...
                                    <div class="card-tools">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input day-toggle" 
                                                   id="toggle_{{ $dayKey }}" data-day="{{ $dayKey }}" 
                                                   {{ $isActive ? 'checked' : '' }}>
                                ...
                                <div class="card-body day-schedule" id="schedule_{{ $dayKey }}" 
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="time" 
                                                               ...
                                                               value="{{ old('schedules.'.$loop->index.'.clock_in', $existingSchedule ? $existingSchedule->clock_in : '08:00') }}"
                                                               {{ $isActive ? 'required' : '' }}>
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="time" 
                                                               ...
                                                               value="{{ old('schedules.'.$loop->index.'.clock_out', $existingSchedule ? $existingSchedule->clock_out : '17:00') }}"
                                                               {{ $isActive ? 'required' : '' }}>
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="time" 
                                                               ...
                                                               value="{{ old('schedules.'.$loop->index.'.break_start_time', $existingSchedule ? $existingSchedule->break_start_time : '') }}">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="time" 
                                                               ...
                                                               value="{{ old('schedules.'.$loop->index.'.break_end_time', $existingSchedule ? $existingSchedule->break_end_time : '') }}">
                                    ...
                                    <input type="hidden" name="schedules[{{ $loop->index }}][is_holiday]" 
                                           value="{{ $isActive ? '0' : '1' }}" class="holiday-input">
                                </div>
                                <div class="card-footer text-center holiday-notice" id="holiday_{{ $dayKey }}" 
                                     style="{{ $isActive ? 'display: none;' : '' }}">
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Update Jadwal Kerja
                            </button>
                        </div>
                    </div>
                </form>
